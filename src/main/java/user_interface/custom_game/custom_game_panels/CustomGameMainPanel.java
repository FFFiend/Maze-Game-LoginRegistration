...
class CustomGameMainPanel extends Panel implements ICustomGamePanel {
    private final JFrame FRAME = new JFrame("custom game main frame");
    ...
    protected CustomGameMainPanel (){
        ...
        //every this.FRAME ll be replaced by this once custom mazes are linked to the main game and the
