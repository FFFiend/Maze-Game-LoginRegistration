...
public class CustomAssetSetter {
    ...
    public void setAssets(){
        ...
        while(col < MAX_PANEL_COL && row < MAX_PANEL_ROW){
            ...
            switch (assetNum) {
                case 1: mazeHazards.addObstacle(new Obstacle(row, col)); break;
                case 2: mazeHazards.addEnemy(new StationaryEnemy(row, col)); break;
                case 3: mazeItems.add(new ItemKey(row, col)); break;
                case 4: mazeItems.add(new ItemPhotons(row, col)); break;
                case 5: mazeItems.add(new ItemBlackhole(row, col));
            }
            col++;
            if(col == MAX_PANEL_COL){
                col = 0;
     ...
     *  Getters for testing
     */
    public int[][] getMazeAssetNum() {return this.mazeAssetNum;}
    public MazeItems getMazeItems() {return this.mazeItems;}
    public MazeHazards getMazeHazards() {return this.mazeHazards;}
}
